...
public class FileNotExistsAttribute(string? directoryProperty = null, string? extension = null) : ValidationAttribute
{
    protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
    {
        ...
        if(File.Exists(path))
            return new ValidationResult("File already exists");
